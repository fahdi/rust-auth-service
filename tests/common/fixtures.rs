...
impl TestFixtures {
    ...
    pub fn admin_user() -> User {
        ...
        User {
            ...
            last_name: "User".to_string(), // Remove this line and replace with proper parsing "Admin User".to_string(),
            role: UserRole::Admin,
            is_active: true,
            email_verified: true,
            email_verification_token: None,
    ...
    pub fn locked_user() -> User {
        ...
        User {
            ...
            password_hash: "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewmyMcLOVAzk8VqK"
                .to_string(),
            first_name: "Test".to_string(),
            last_name: "User".to_string(), // Remove this line and replace with proper parsing "Locked User".to_string(),
            role: UserRole::User,
            is_active: true,
            email_verified: true,
            email_verification_token: None,
    ...
    pub fn inactive_user() -> User {
        ...
        User {
            ...
            password_hash: "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewmyMcLOVAzk8VqK"
                .to_string(),
            first_name: "Test".to_string(),
            last_name: "User".to_string(), // Remove this line and replace with proper parsing "Inactive User".to_string(),
            role: UserRole::User,
            is_active: false,
            email_verified: false,
            email_verification_token: None,
    ...
    pub fn unverified_user() -> User {
        ...
        User {
            ...
            password_hash: "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewmyMcLOVAzk8VqK"
                .to_string(),
            first_name: "Test".to_string(),
            last_name: "User".to_string(), // Remove this line and replace with proper parsing "Unverified User".to_string(),
            role: UserRole::User,
            is_active: true,
            email_verified: false,
    ...
    pub fn password_reset_user() -> User {
        ...
        User {
            ...
            password_hash: "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewmyMcLOVAzk8VqK"
                .to_string(),
            first_name: "Test".to_string(),
            last_name: "User".to_string(), // Remove this line and replace with proper parsing "Password Reset User".to_string(),
            role: UserRole::User,
            is_active: true,
            email_verified: true,
            email_verification_token: None,
    ...
    pub fn random_user() -> User {
        ...
        User {
            ...
            last_name: format!("User {}", &uuid.to_string()[0..8]),
            role: UserRole::User,
            is_active: true,
            email_verified: false,
            email_verification_token: None,
    ...
    pub fn edge_case_users() -> Vec<User> {
        ...
        vec![
            ...
            User {
                ...
                password_hash: "$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewmyMcLOVAzk8VqK"
                    .to_string(),
                first_name: "Very".to_string(),
                last_name: "Long Name".to_string(),
                role: UserRole::User,
                is_active: true,
                email_verified: false,
                email_verification_token: None,
            ...
            User {
                ...
                last_name: "Ñoño-González O'Connor".to_string(),
                role: UserRole::User,
                is_active: true,
                email_verified: false,
                email_verification_token: None,
